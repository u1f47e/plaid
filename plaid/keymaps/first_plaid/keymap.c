...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    FN, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  _______,RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_COLEMAK] = LAYOUT_plaid_grid(
    ...
    LSFT_T(KC_CAPS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    FN, KC_LCTL, KC_LALT, KC_LGUI, LOWER,  KC_SPC,  _______,RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, KC_MPLY,_______,_______,    KC_MRWD,    KC_VOLD, KC_VOLU, KC_MFFD
),
...
[_RAISE] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, KC_MPLY,_______, _______, KC_BRID, KC_VOLD, KC_VOLU, KC_BRIU
),
